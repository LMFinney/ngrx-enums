(function (global, factory) {
	...
	(factory((global.ngrxEnums = global.ngrxEnums || {})));
...
var ActionEnum = /** @class */ (function (_super) {
    ...
    ActionEnum.of = function (actions$) {
        ...
        return observable.pipe(map(function (action) { return action.payload; }));
    };
    /**
     * For use in reducer. Acts as both a Typescript type guard and a means for
     * determining which reducer code to execute.
...
var ReducerEnumValue = /** @class */ (function (_super) {
    __extends$2(ReducerEnumValue, _super);
    function ReducerEnumValue(action, _reduce) {
        ...
        _this.actions = Array.isArray(action) ? action : [action];
        return _this;
    }
...
var ReducerEnum = /** @class */ (function (_super) {
    __extends$2(ReducerEnum, _super);
...
exports.TypedAction = TypedAction;
exports.ActionEnumValue = ActionEnumValue;
exports.ActionEnum = ActionEnum;
exports.simplePropertyReducer = simplePropertyReducer;
exports.ReducerEnumValue = ReducerEnumValue;
exports.ReducerEnum = ReducerEnum;

Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=ngrx-enums.umd.js.map
